...
## Bull Whip Agent Integration

This skill is designed for the Bull Whip agent. It uses Bull Whip tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Bull Whip skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.bullwhip/plans/` | `skill_view("plan")` |
