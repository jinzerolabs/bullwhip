...
curl -s -X PATCH "https://api.notion.com/v1/blocks/{page_id}/children" \
  ...
  -d '{
    "children": [
      {"object": "block", "type": "paragraph", "paragraph": {"rich_text": [{"text": {"content": "Hello from Bull Whip!"}}]}}
    ]
  }'
```
...
- Add `-s` flag to curl to suppress progress bars (cleaner output for Bull Whip)
