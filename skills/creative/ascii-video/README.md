...
Built for [Bull Whip Agent](https://github.com/ZeroLabsKorea/bullwhip-agent). Usable in any coding agent. Canonical source lives here; synced to [`ZeroLabsKorea/bullwhip-agent/skills/creative/ascii-video`](https://github.com/ZeroLabsKorea/bullwhip-agent/tree/main/skills/creative/ascii-video) via PR.
