...
DEFAULT_DATASETS = [
    ...
    "NousResearch/bullwhip-agent-megascience-sft1",
    "NousResearch/BullWhip-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/BullWhip-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-bullwhip-agent"
]
