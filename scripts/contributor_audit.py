...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^BullWhip\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "bullwhip@nousresearch.com",
    "bullwhip-audit@example.com",
    "bullwhip@habibilabs.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/bullwhip-agent",
                "--state", "merged",
