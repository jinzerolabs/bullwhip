#!/usr/bin/env python3
"""Build the Bull Whip Skills Index — a centralized JSON catalog of all skills.
...
`bullwhip skills search/install` can use it without hitting the GitHub API.
...
# Ensure BULLWHIP_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("BULLWHIP_HOME", os.path.join(os.path.expanduser("~"), ".bullwhip"))
...
def main():
    print("Building BullWhip Skills Index...", flush=True)
