...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("bullwhip_cli.config.get_config_path", return_value=config_path), \
             patch("bullwhip_cli.config.ensure_bullwhip_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("bullwhip_cli.config.get_env_path", return_value=env_path), \
             patch("bullwhip_cli.config.ensure_bullwhip_home"):
    ...
    def test_ensure_bullwhip_home_sets_0700(self):
        home = Path(self.tmpdir) / ".bullwhip"
        with patch("bullwhip_cli.config.get_bullwhip_home", return_value=home):
