...
class TestXiaomiAliases:
    ...
    def test_normalize_provider_models_py(self):
        from bullwhip_cli.models import normalize_provider
        assert normalize_provider("mimo") == "xiaomi"
        assert normalize_provider("xiaomi-mimo") == "xiaomi"

    def test_normalize_provider_providers_py(self):
        from bullwhip_cli.providers import normalize_provider
        assert normalize_provider("mimo") == "xiaomi"
        assert normalize_provider("xiaomi-mimo") == "xiaomi"
...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from bullwhip_cli.model_normalize import _VENDOR_PREFIXES
    ...
    def test_matching_prefix_strip(self):
        ...
        from bullwhip_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in BULLWHIP_OVERLAYS
        overlay = BULLWHIP_OVERLAYS["xiaomi"]
    ...
    def test_get_provider(self):
        pdef = None
        try:
            from bullwhip_cli.providers import get_provider
...
class TestXiaomiDoctor:
    """Verify bullwhip doctor recognizes Xiaomi env vars."""

    def test_provider_env_hints(self):
        from bullwhip_cli.doctor import _PROVIDER_ENV_HINTS
...
class TestXiaomiAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from bullwhip_cli.providers import BULLWHIP_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = BULLWHIP_OVERLAYS["xiaomi"]
