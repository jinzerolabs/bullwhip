"""Tests for the interactive session browser (`bullwhip sessions browse`).
...
from bullwhip_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """bullwhip sessions browse should be parseable."""
        from bullwhip_cli.main import main as _main_entry
