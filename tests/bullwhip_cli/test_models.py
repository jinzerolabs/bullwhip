"""Tests for the bullwhip_cli models module."""
...
import bullwhip_cli.models as _models_mod
...
class TestModelIds:
    def test_returns_non_empty_list(self):
        with patch("bullwhip_cli.models.fetch_openrouter_models", return_value=LIVE_OPENROUTER_MODELS):
            ids = model_ids()
...
class TestFetchOpenRouterModels:
    ...
    def test_falls_back_to_static_snapshot_on_fetch_failure(self, monkeypatch):
        monkeypatch.setattr(_models_mod, "_openrouter_catalog_cache", None)
        with patch("bullwhip_cli.models.urllib.request.urlopen", side_effect=OSError("boom")):
            models = fetch_openrouter_models(force_refresh=True)
...
class TestFindOpenrouterSlug:
    def test_exact_match(self):
        from bullwhip_cli.models import _find_openrouter_slug
        with patch("bullwhip_cli.models.fetch_openrouter_models", return_value=LIVE_OPENROUTER_MODELS):
...
class TestCheckNousFreeTierCache:
    ...
    @patch("bullwhip_cli.models.fetch_nous_account_tier")
    @patch("bullwhip_cli.models.is_nous_free_tier", return_value=True)
    def test_result_is_cached(self, mock_is_free, mock_fetch):
        ...
        with patch("bullwhip_cli.auth.get_provider_auth_state", return_value={"access_token": "tok"}), \
             patch("bullwhip_cli.auth.resolve_nous_runtime_credentials"):
    ...
    @patch("bullwhip_cli.models.fetch_nous_account_tier")
    @patch("bullwhip_cli.models.is_nous_free_tier", return_value=False)
