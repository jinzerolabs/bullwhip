"""Tests for bullwhip claw commands."""
...
from bullwhip_cli import claw as claw_mod
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.bullwhip/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.bullwhip/memories/MEMORY.md"},
    ...
    def test_execute_report(self, capsys):
        report = {
            ...
            "output_dir": "/home/user/.bullwhip/migration/openclaw/20250312T120000",
        }
