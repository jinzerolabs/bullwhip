...
See: https://github.com/NousResearch/bullwhip-agent/issues/4426
"""
...
class TestGetSubprocessHome:
    """Unit tests for bullwhip_constants.get_subprocess_home()."""

    def test_returns_none_when_bullwhip_home_unset(self, monkeypatch):
    ...
    def test_returns_path_when_home_dir_exists(self, tmp_path, monkeypatch):
        bullwhip_home = tmp_path / ".bullwhip"
        bullwhip_home.mkdir()
        profile_home = bullwhip_home / "home"
        profile_home.mkdir()
        monkeypatch.setenv("BULLWHIP_HOME", str(bullwhip_home))
        from bullwhip_constants import get_subprocess_home
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        base = tmp_path / ".bullwhip" / "profiles"
        ...
        monkeypatch.setenv("BULLWHIP_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("BULLWHIP_HOME", str(base / "beta"))
...
class TestMakeRunEnvHomeInjection:
    ...
    def test_injects_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        assert result["HOME"] == str(bullwhip_home / "home")
    ...
    def test_no_injection_when_bullwhip_home_unset(self, monkeypatch):
        monkeypatch.delenv("BULLWHIP_HOME", raising=False)
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from bullwhip_cli.profiles import _PROFILE_DIRS
    ...
    def test_create_profile_bootstraps_home_dir(self, tmp_path, monkeypatch):
        ...
        from bullwhip_cli.profiles import create_profile
