...
COMMON_BULLWHIP_TOOLS = ["read_file", "search_files", "terminal", "patch", "write_file", "process"]


class TestToolKindMap:
    def test_allbullwhip_tools_have_kind(self):
        """Every common bullwhip tool should appear in TOOL_KIND_MAP."""
        for tool in COMMON_BULLWHIP_TOOLS:
