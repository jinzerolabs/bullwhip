...
class TestParserRegistry:
    ...
    def test_bullwhip_parser_registered(self):
        parsers = list_parsers()
        assert "bullwhip" in parsers
...
# ─── BullWhip parser tests ────────────────────────────────────────────────

class TestBullWhipParser:
    @pytest.fixture
    def parser(self):
        return get_parser("bullwhip")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["bullwhip"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use bullwhip format since that's universal
