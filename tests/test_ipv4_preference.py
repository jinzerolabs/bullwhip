...
def _reload_constants():
    """Reload bullwhip_constants to get a fresh apply_ipv4_preference."""
    import bullwhip_constants
    importlib.reload(bullwhip_constants)
    return bullwhip_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "bullwhip_ipv4_patched", False) is True
