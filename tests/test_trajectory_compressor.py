...
def test_import_loads_env_from_bullwhip_home(tmp_path, monkeypatch):
    home = tmp_path / ".bullwhip"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-bullwhip-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-bullwhip-home"
