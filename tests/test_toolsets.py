...
class TestToolsetConsistency:
    ...
    def testbullwhip_platforms_share_core_tools(self):
        """All bullwhip-* platform toolsets should have the same tools."""
        platforms = ["bullwhip-cli", "bullwhip-telegram", "bullwhip-discord", "bullwhip-whatsapp", "bullwhip-slack", "bullwhip-signal", "bullwhip-homeassistant"]
