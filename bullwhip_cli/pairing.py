...
Usage:
    bullwhip pairing list              # Show all pending + approved users
    bullwhip pairing approve <platform> <code>  # Approve a pairing code
    bullwhip pairing revoke <platform> <user_id> # Revoke user access
    bullwhip pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle bullwhip pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: bullwhip pairing {list|approve|revoke|clear-pending}")
        print("Run 'bullwhip pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'bullwhip pairing list' to see pending codes.\n")
