"""BullWhip CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.bullwhip/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Bull Whip Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! 🐂"              # Shown on exit
      response_label: " 🐂 Bull Whip "       # Response box header label
...
.. code-block:: python
    ...
    from bullwhip_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Bull Whip Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.bullwhip/skins/

BUILT-IN SKINS
==============

- ``default`` — Classic BullWhip gold/kawaii (the current look)
...
Drop a YAML file in ``~/.bullwhip/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces BULLWHIP_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces BULLWHIP_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic BullWhip — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Bull Whip Agent",
            "welcome": "Welcome to Bull Whip Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! 🐂",
            "response_label": " 🐂 Bull Whip ",
            "prompt_symbol": "❯ ",
...
def _skins_dir() -> Path:
    ...
    return get_bullwhip_home() / "skins"
