"""
Skills configuration for Bull Whip Agent.
`bullwhip skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.bullwhip/config.yaml under:
...
from bullwhip_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `bullwhip skills`."""
    from bullwhip_cli.curses_ui import curses_checklist
