...
Trust levels:
  - builtin:   Ships with Bull Whip. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.bullwhip/\.env|\~/\.bullwhip/\.env',
     "hermes_env_access", "critical", "exfiltration",
     "directly references BullWhip secrets file"),
    ...
    (r'\.bullwhip/config\.yaml|\.bullwhip/SOUL\.md',
     "hermes_config_mod", "critical", "persistence",
     "references BullWhip configuration files directly"),
