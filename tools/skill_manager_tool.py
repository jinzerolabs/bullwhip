...
~/.bullwhip/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.bullwhip/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.bullwhip/skills/) first, then any
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "New skills go to ~/.bullwhip/skills/; existing skills can be modified wherever they live.\n\n"
