...
def _build_child_system_prompt(
    ...
    *,
    ...
    parts.append(
        ...
        "(e.g. a service is not running, a dependency is missing, a permission "
        "is denied), your summary MUST include:\n"
        "- The exact error message or output\n"
        "- What prerequisite is missing or what the user needs to do\n"
        "- The specific command or step to resolve it\n"
        "Do NOT just say 'it failed' — explain WHY so the parent agent can "
        "either fix it automatically or give the user a clear action item.\n\n"
