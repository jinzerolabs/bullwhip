---
sidebar_position: 8
title: "Use Voice Mode with Bull Whip"
description: "A practical guide to setting up and using Bull Whip voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Bull Whip
...
- you want Bull Whip sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Bull Whip.
...
## Step 1: make sure normal Bull Whip works first
...
Bull Whip supports both local and cloud speech stacks.
...
4. Bull Whip transcribes and responds
...
- asking Bull Whip to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Bull Whip loop.

## Tuning CLI behavior

### Silence threshold

If Bull Whip starts/stops too aggressively, tune:
...
Bull Whip stays a normal chat bot, but can speak replies.
...
- you want Bull Whip to function like a portable research or ops assistant
...
Bull Whip joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Bull Whip detects speech boundaries
- transcripts are posted in the associated text channel
- Bull Whip responds in text and audio
...
1. get text Bull Whip working
2. install `bullwhip-agent[voice]`
