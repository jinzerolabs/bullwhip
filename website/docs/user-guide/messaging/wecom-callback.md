...
Connect Bull Whip to WeCom (Enterprise WeChat) as a self-built enterprise application using the callback/webhook model.

:::info WeCom Bot vs WeCom Callback
Bull Whip supports two WeCom integration modes:
...
3. Bull Whip decrypts the message, queues it for the agent
