...
slug: /
sidebar_position: 0
title: "Bull Whip Agent Documentation"
description: "The self-improving AI agent built by ZeroLabs Korea. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
hide_table_of_contents: true
---

# Bull Whip Agent

The self-improving AI agent built by [ZeroLabs Korea](https://zerolabskorea.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/ZeroLabsKorea/bullwhip-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>

## What is Bull Whip Agent?
...
| 🔌 **[MCP Integration](/docs/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Bull Whip safely |
| 🧭 **[Use MCP with Bull Whip](/docs/guides/use-mcp-with-bullwhip)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/docs/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Bull Whip](/docs/guides/use-voice-mode-with-bullwhip)** | Hands-on setup and usage patterns for Bull Whip voice workflows |
| 🎭 **[Personality & SOUL.md](/docs/user-guide/features/personality)** | Define Bull Whip' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/docs/guides/tips)** | Quick wins to get the most out of Bull Whip |
...
- **Built by model trainers** — Created by [ZeroLabs Korea](https://zerolabskorea.com), the lab behind Bull Whip, Nomos, and Psyche. Works with [Nous Portal](https://portal.zerolabskorea.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [ZeroLabs Korea](https://zerolabskorea.com) — the lab behind Bull Whip, Nomos, and Psyche models
