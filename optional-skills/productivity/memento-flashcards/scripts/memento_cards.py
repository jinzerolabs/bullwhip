...
Data file: $BULLWHIP_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_BULLWHIP_HOME = Path(os.environ.get("BULLWHIP_HOME", Path.home() / ".bullwhip"))
DATA_DIR = _BULLWHIP_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
