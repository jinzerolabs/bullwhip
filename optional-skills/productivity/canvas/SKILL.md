...
4. Name the token (e.g., "Bull Whip Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.bullwhip/.env`:
...
```bash
CANVAS="python $BULLWHIP_HOME/skills/productivity/canvas/scripts/canvas_api.py"
