"""
Email platform adapter for the Bull Whip gateway.

Allows users to interact with Bull Whip by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Bull Whip Agent")
        ...
        msg_id = f"<bullwhip-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
