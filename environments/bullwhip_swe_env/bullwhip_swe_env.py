"""
BullWhipSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser bullwhip
    run-api
    python environments/bullwhip_swe_env.py serve \\
...
class BullWhipSweEnv(BullWhipAgentBaseEnv):
    ...
    name = "bullwhip-swe"
    env_config_cls = BullWhipSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[BullWhipSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        """
        env_config = BullWhipSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepBullWhip-3-Llama-3-3B-Preview",
            tool_call_parser="bullwhip",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="bullwhip-swe",
        )

        server_configs = [
            APIServerConfig(
                base_url="http://localhost:8000/v1",
                model_name="NousResearch/DeepBullWhip-3-Llama-3-3B-Preview",
