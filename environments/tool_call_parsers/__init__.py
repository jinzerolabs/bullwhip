...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("bullwhip")
        class BullWhipToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "bullwhip", "mistral", "llama3_json")
...
from environments.tool_call_parsers.bullwhip_parser import BullWhipToolCallParser  # noqa: E402, F401
