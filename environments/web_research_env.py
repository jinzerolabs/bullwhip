...
Inspired by: GroceryMind — production Bull Whip agent doing live web research
             across German grocery stores (firecrawl + bullwhip-agent)
"""
...
# Ensure bullwhip-agent root is on path
...
class WebResearchEnvConfig(BullWhipAgentEnvConfig):
...
class WebResearchEnv(BullWhipAgentBaseEnv):
    """
