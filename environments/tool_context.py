...
ALL bullwhip-agent tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all bullwhip-agent tools for a specific rollout.
    ...
    def upload_file(self, local_path: str, remote_path: str) -> Dict[str, Any]:
        ...
        if len(b64) <= chunk_size:
            ...
            tmp_b64 = "/tmp/bullwhip_upload.b64"
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any bullwhip-agent tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("BULLWHIP_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("BULLWHIP_QUIET", None)
            else:
                os.environ["BULLWHIP_QUIET"] = _prev_quiet
