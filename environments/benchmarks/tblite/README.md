...
- **Dataset (ours):** [ZeroLabsKorea/openthoughts-tblite](https://huggingface.co/datasets/ZeroLabsKorea/openthoughts-tblite)
- **Docker images:** `zerolabskorea/tblite-<task-name>:latest` on Docker Hub (100 images)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `ZeroLabsKorea/terminal-bench-2`  | `ZeroLabsKorea/openthoughts-tblite`      |
| Tasks          | 89                               | 100                                     |
