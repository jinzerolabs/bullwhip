#!/usr/bin/env python3
"""
SWE Runner with Bull Whip Trajectory Format

A runner that uses BullWhip-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Bull Whip-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses BullWhip-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in BullWhip format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches BullWhip-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using BullWhip-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Bull Whip Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses BullWhip-Agent's built-in execution environments
    and outputs trajectories in BullWhip-Agent format.
    """
    ...
    def _convert_tobullwhip_format(
        self,
        ...
        """
        Convert internal message format to Bull Whip trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Bull Whip trajectory format
        trajectory = self._convert_tobullwhip_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Bull Whip trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Bull Whip Trajectory Format")
    print("=" * 60)
